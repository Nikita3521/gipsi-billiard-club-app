...
import { tournamentDetails } from "@/consts/tournamentDetails"
...
export default function TournamentsPage() {
  ...
  const spotsLeft =
    tournamentDetails.maxParticipants - tournamentDetails.registeredCount
      ...
      <div className="mx-auto w-full max-w-5xl px-4 py-12 lg:py-12">
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm font-semibold text-white">
                      {tournamentDetails.registeredCount} /{" "}
                      {tournamentDetails.maxParticipants} registered
                    </span>
                  </div>
        ...
        >
          ...
          <ul className="mt-6 grid grid-cols-1 gap-1 sm:grid-cols-2">
            {tournamentDetails.rules.map((rule) => (
              <li
                key={rule}
